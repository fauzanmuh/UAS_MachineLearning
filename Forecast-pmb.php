...
<body>
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      <a class="navbar-brand" href="#">Prediksi PMB</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="forecast-pmb.php">Prediksi</a>
          </li>
        </ul>
    ...
    <div class="jumbotron">
      <h2>Prediksi</h2>
      <hr>
      <p>Lakukan Prediksi PMB</p>
      <form class="form-inline" action="forecasting.php" method="post">
        <label class="sr-only" for="inlineFormInputName2">Name</label>
        <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" name="tahun" placeholder="Masukkan Tahun Prediksi" required>
